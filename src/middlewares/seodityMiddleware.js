        ...
        async (responseBuffer, proxyRes, req, res) => {
            ...
            if (
                ...
                links.each(function() {
                    ...
                    if (href !== undefined) {
                        $(this).attr("href", href.replace("https://app.seodity.com", domain));
                    }
                });
                let forms = $("form");
                forms.each(function() {
                    ...
                    if (action !== undefined) {
                        $(this).attr("action", action.replace("https://app.seodity.com", domain));
                    }
                });
                let anchors = $("a");
                ...
                scripts.each(function() {
                    ...
                    if (src != undefined) {
                        $(this).attr("src", src.replace("https://app.seodity.com", domain));
                    }
                });
                $("head").append(`
                    <style>
